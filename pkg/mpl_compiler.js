...
export class WasmMPLCompiler {
    ...
    validate(script) {
        const ptr0 = passStringToWasm0(script, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmmplcompiler_validate(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
    ...
    get_version() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmmplcompiler_get_version(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('mpl_compiler_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
