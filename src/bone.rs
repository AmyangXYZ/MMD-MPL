    ...
    fn build_rules() -> HashMap<String, HashMap<String, HashMap<String, ActionRule>>> {
        ...
        rules! {
            ...
            "index_0_l" => {
                ...
                "sway" => {
                    "left" => [0.53, -0.84, 0.0], 15.0,
                    "right" => [-0.53, 0.84, 0.0], 15.0,
                },
            },
            "index_1_l" => {
                "bend" => {
            ...
            "middle_0_l" => {
                "bend" => {
                    ...
                    "backward" => [0.03, 0.0, 0.996], 15.0,
                },
                "sway" => {
                    "left" => [0.55, -0.83, -0.0], 45.0,
                    "right" => [-0.55, 0.83, -0.0], 45.0,
                },
            },
            "middle_1_l" => {
                "bend" => {
            ...
            "ring_0_l" => {
                ...
                "sway" => {
                    "left" => [0.475, -0.654, 0.0], 45.0,
                    "right" => [-0.475, 0.654, 0.0], 45.0,
                },
            },
            "ring_1_l" => {
                "bend" => {
            ...
            "pinky_0_l" => {
                "bend" => {
                    ...
                    "backward" => [0.088, 0.0, 0.997], 15.0,
                },
                "sway" => {
                    "left" => [0.526, -0.851, 0.0], 45.0,
                    "right" => [-0.526, 0.851, 0.0], 45.0,
                },
            },
            "pinky_1_l" => {
                "bend" => {
