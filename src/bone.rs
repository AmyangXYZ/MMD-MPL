    ...
    fn build_rules() -> HashMap<String, HashMap<String, HashMap<String, ActionRule>>> {
        ...
        rules! {
            ...
            "wrist_l" => {
                ...
                "sway" => {
                    "left" => [-1.0, -1.0, 0.0], 30.0,
                    "right" => [1.0, 1.0, 0.0], 30.0,
                },
            },
            "wrist_r" => {
                "bend" => {
            ...
            "index_0_l" => {
                "bend" => {
                    "forward" => [-0.05, 0.0, -1.0], 90.0,
                    "backward" => [-0.05, 0.0, 1.0], 15.0,
                },
                "sway" => {
            ...
            "ring_0_l" => {
                "bend" => {
                    "forward" => [0.15, 0.0, -1.0], 90.0,
                    "backward" => [0.15, 0.0, 1.0], 15.0,
                },
                "sway" => {
                    "left" => [-1.0, 0.0, 0.05], 45.0,
                    "right" => [1.0, 0.0, 0.05], 45.0,
                },
            },
            "ring_1_l" => {
                "bend" => {
            ...
            "pinky_0_l" => {
                "bend" => {
                    "forward" => [0.3, 0.0, -1.0], 90.0,
                    "backward" => [0.3, 0.0, 1.0], 15.0,
                },
                "sway" => {
                    "left" => [-1.0, 0.0, 0.0], 45.0,
                    "right" => [1.0, 0.0, 0.0], 45.0,
